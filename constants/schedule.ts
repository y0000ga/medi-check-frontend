...
export const DOSE_UNIT_OPTIONS = Object.values(DoseUnit).map(value => ({ value, label: DOSE_UNIT_LABELS[value] }))
...
export const END_TYPE_OPTIONS = Object.values(ScheduleEndType).map(value => ({ value, label: END_TYPE_LABEL[value] }))
