...
const DB_USERS: IDB_User[] = [
  ...
  },
  {
    ...
    avatarUrl:
      "https://api.dicebear.com/7.x/initials/svg?seed=Amy+Chen",
    isEmailVerified: true,
    status: UserStatus.active,
  ...
  },
  {
    ...
    avatarUrl:
      "https://api.dicebear.com/7.x/initials/svg?seed=Kevin+Lin",
  ...
  },
  {
    ...
    passwordHash: null,
    avatarUrl:
      "https://api.dicebear.com/7.x/initials/svg?seed=Sophie+Wang",
    isEmailVerified: true,
    status: UserStatus.active,
  ...
  },
  {
    ...
    passwordHash: null,
    avatarUrl:
      "https://api.dicebear.com/7.x/initials/svg?seed=Invited+User",
    isEmailVerified: false,
  ...
  },
  {
    ...
    avatarUrl:
      "https://api.dicebear.com/7.x/initials/svg?seed=Disabled+User",
    isEmailVerified: true,
...
export const DB_PATIENTS: IDB_Patient[] = [
  {
    ...
    avatarUrl:
      "https://api.dicebear.com/7.x/initials/svg?seed=Demo+User+Patient",
  ...
  },
  {
    ...
    avatarUrl:
      "https://api.dicebear.com/7.x/initials/svg?seed=Lin+Grandma",
  ...
  },
  {
    ...
    avatarUrl:
      "https://api.dicebear.com/7.x/initials/svg?seed=Amy+Chen+Patient",
  ...
  },
  {
    ...
    avatarUrl:
      "https://api.dicebear.com/7.x/initials/svg?seed=Kevin+Lin+Patient",
  ...
  },
  {
    ...
    avatarUrl:
      "https://api.dicebear.com/7.x/initials/svg?seed=Uncle+Wu",
...
export const RES_PATIENTS: IRES_Patient[] = DB_PATIENTS.map(
  (patient) => ({
    id: patient.id,
...
export const RES_CARE_RELATIONSHIPS: IRES_CareRelationship[] =
  DB_CARE_RELATIONSHIPS.map((relationship) => ({
    id: relationship.id,
...
const MEDICATION_SEEDS = [
  {
    id: "med-01",
    name: "Vitamin C",
    dosageForm: DosageForm.Softgel,
    memo: "Take after breakfast if stomach feels sensitive.",
  },
  {
    id: "med-02",
    name: "Omega 3",
    dosageForm: DosageForm.Softgel,
    memo: "Keep with lunch box on office days.",
  },
  {
    id: "med-03",
    name: "Pain Relief",
    dosageForm: DosageForm.Pill,
    memo: "Only use when headache or muscle soreness shows up.",
  },
  {
    id: "med-04",
    name: "Eye Drops",
    dosageForm: DosageForm.Liquid,
    memo: "Remove contact lenses before using.",
  },
  {
    id: "med-05",
    name: "Nasal Spray",
    dosageForm: DosageForm.Spray,
    memo: "Do not exceed the prescribed daily number of sprays.",
  },
  {
    id: "med-06",
    name: "Cough Syrup",
    dosageForm: DosageForm.Liquid,
    memo: "Use the measuring cup stored in the top drawer.",
  },
  {
    id: "med-07",
    name: "Calcium",
    dosageForm: DosageForm.Tablet,
    memo: "Prefer taking at night, away from iron supplement.",
  },
  {
    id: "med-08",
    name: "Probiotic",
    dosageForm: DosageForm.Capsule,
    memo: "Keep refrigerated after opening.",
  },
  {
    id: "med-09",
    name: "Protein Powder",
    dosageForm: DosageForm.Powder,
    memo: "Mix with 300ml of water after exercise.",
  },
  {
    id: "med-10",
    name: "Vitamin D",
    dosageForm: DosageForm.Tablet,
    memo: "Take together with a meal that includes fat.",
  },
  {
    id: "med-11",
    name: "Iron Supplement",
    dosageForm: DosageForm.Tablet,
    memo: "Avoid tea or coffee within one hour.",
  },
  {
    id: "med-12",
    name: "Allergy Relief",
    dosageForm: DosageForm.Pill,
    memo: "May cause drowsiness on the first few doses.",
  },
  {
    id: "med-13",
    name: "Sleep Aid",
    dosageForm: DosageForm.Capsule,
    memo: "Only take when already ready for bed.",
  },
  {
    id: "med-14",
    name: "Digestive Enzyme",
    dosageForm: DosageForm.Capsule,
    memo: "Best taken right before heavier meals.",
  },
  {
    id: "med-15",
    name: "Skin Ointment",
    dosageForm: DosageForm.Liquid,
    memo: "Apply only to the affected area after cleansing.",
  },
  {
    id: "med-16",
    name: "B Complex",
    dosageForm: DosageForm.Tablet,
    memo: "Take in the morning to avoid sleep disruption.",
  },
  {
    id: "med-17",
    name: "Electrolyte Mix",
    dosageForm: DosageForm.Powder,
    memo: "Use more often on days with intense outdoor activity.",
  },
  {
    id: "med-18",
    name: "Cold Relief",
    dosageForm: DosageForm.Capsule,
    memo: "Stop once fever and sore throat have resolved.",
  },
];

const MEDICATION_PATIENT_BY_INDEX: Partial<
  Record<number, IDB_Patient["id"]>
> = {
  0: "p0",
  1: "p1",
  2: "p1",
...
export const DB_MEDICATIONS: IDB_Medication[] = MEDICATION_SEEDS.map(
  (item, index) => ({
    ...item,
...
export const RES_MEDICATIONS: IRES_Medication[] = DB_MEDICATIONS.map(
  ({ id, patientId, name, dosageForm, memo }) => ({
    id,
    patientId,
    name,
    dosageForm,
...
type ScheduleSeed = Omit<
  IDB_Schedule,
  "patientId" | "medicationId" | "timezone" | "id"
> & { medicationIndex: number };

const SCHEDULE_SEEDS: ScheduleSeed[] = [
  {
    medicationIndex: 0,
    startAt: NOW.subtract(8, "day")
      .hour(7)
      .minute(30)
      .second(0)
      .millisecond(0)
...
export const RES_SCHEDULES: IDB_Schedule[] = SCHEDULE_SEEDS.map(
  (seed, index) => ({
...
const historyOccurrence = (
  ...
  const schedule = RES_SCHEDULES.find(
  ...
  return buildOccurrenceTime(
    schedule,
    NOW.add(dateOffset, "day"),
    schedule.timeSlots[0] ?? "08:00",
  );
};

const DB_HISTORY_SEEDS: Omit<
  IDB_History,
  | "takenAmount"
  | "memo"
  | "feeling"
...
>[] = [
  {
    id: "his-01",
    scheduleId: "sch-01",
    scheduledTime: historyOccurrence("sch-01", 0),
    intakenTime: dayjs(historyOccurrence("sch-01", 0))
      .add(12, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 5,
    medicationIdSnapshot: "med-01",
    medicationNameSnapshot: "Vitamin C",
    medicationDosageFormSnapshot: DosageForm.Softgel,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Capsule,
  },
  {
    id: "his-02",
    scheduleId: "sch-02",
    scheduledTime: historyOccurrence("sch-02", 0),
    intakenTime: dayjs(historyOccurrence("sch-02", 0))
      .add(25, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 4,
    medicationIdSnapshot: "med-02",
    medicationNameSnapshot: "Omega 3",
    medicationDosageFormSnapshot: DosageForm.Softgel,
    amountSnapshot: 2,
    doseUnitSnapshot: DoseUnit.Capsule,
  },
  {
    id: "his-03",
    scheduleId: "sch-03",
    scheduledTime: historyOccurrence("sch-03", -1),
    intakenTime: dayjs(historyOccurrence("sch-03", -1))
      .add(18, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 5,
    medicationIdSnapshot: "med-03",
    medicationNameSnapshot: "Pain Relief",
    medicationDosageFormSnapshot: DosageForm.Pill,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Tablet,
  },
  {
    id: "his-04",
    scheduleId: "sch-04",
    scheduledTime: historyOccurrence("sch-04", -1),
    intakenTime: dayjs(historyOccurrence("sch-04", -1))
      .add(7, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 4,
    medicationIdSnapshot: "med-04",
    medicationNameSnapshot: "Eye Drops",
    medicationDosageFormSnapshot: DosageForm.Liquid,
    amountSnapshot: 2,
    doseUnitSnapshot: DoseUnit.Drop,
  },
  {
    id: "his-05",
    scheduleId: "sch-05",
    scheduledTime: historyOccurrence("sch-05", -2),
    intakenTime: dayjs(historyOccurrence("sch-05", -2))
      .add(5, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 3,
    medicationIdSnapshot: "med-05",
    medicationNameSnapshot: "Nasal Spray",
    medicationDosageFormSnapshot: DosageForm.Spray,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Drop,
  },
  {
    id: "his-06",
    scheduleId: "sch-06",
    scheduledTime: historyOccurrence("sch-06", -2),
    intakenTime: dayjs(historyOccurrence("sch-06", -2))
      .add(14, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 4,
    medicationIdSnapshot: "med-06",
    medicationNameSnapshot: "Cough Syrup",
    medicationDosageFormSnapshot: DosageForm.Liquid,
    amountSnapshot: 10,
    doseUnitSnapshot: DoseUnit.Ml,
  },
  {
    id: "his-07",
    scheduleId: "sch-07",
    scheduledTime: historyOccurrence("sch-07", -3),
    intakenTime: dayjs(historyOccurrence("sch-07", -3))
      .add(35, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 5,
    medicationIdSnapshot: "med-07",
    medicationNameSnapshot: "Calcium",
    medicationDosageFormSnapshot: DosageForm.Tablet,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Tablet,
  },
  {
    id: "his-08",
    scheduleId: "sch-08",
    scheduledTime: historyOccurrence("sch-08", -3),
    intakenTime: dayjs(historyOccurrence("sch-08", -3))
      .add(20, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 4,
    medicationIdSnapshot: "med-08",
    medicationNameSnapshot: "Probiotic",
    medicationDosageFormSnapshot: DosageForm.Capsule,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Capsule,
  },
  {
    id: "his-09",
    scheduleId: "sch-09",
    scheduledTime: historyOccurrence("sch-09", -4),
    intakenTime: dayjs(historyOccurrence("sch-09", -4))
      .add(30, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 5,
    medicationIdSnapshot: "med-09",
    medicationNameSnapshot: "Protein Powder",
    medicationDosageFormSnapshot: DosageForm.Powder,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Package,
  },
  {
    id: "his-10",
    scheduleId: "sch-10",
    scheduledTime: historyOccurrence("sch-10", -4),
    intakenTime: dayjs(historyOccurrence("sch-10", -4))
      .add(11, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 5,
    medicationIdSnapshot: "med-10",
    medicationNameSnapshot: "Vitamin D",
    medicationDosageFormSnapshot: DosageForm.Tablet,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Tablet,
  },
  {
    id: "his-11",
    scheduleId: "sch-11",
    scheduledTime: historyOccurrence("sch-11", -5),
    intakenTime: dayjs(historyOccurrence("sch-11", -5))
      .add(8, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 3,
    medicationIdSnapshot: "med-11",
    medicationNameSnapshot: "Iron Supplement",
    medicationDosageFormSnapshot: DosageForm.Tablet,
    amountSnapshot: 2,
    doseUnitSnapshot: DoseUnit.Tablet,
  },
  {
    id: "his-12",
    scheduleId: "sch-12",
    scheduledTime: historyOccurrence("sch-12", -5),
    intakenTime: dayjs(historyOccurrence("sch-12", -5))
      .add(16, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 4,
    medicationIdSnapshot: "med-12",
    medicationNameSnapshot: "Allergy Relief",
    medicationDosageFormSnapshot: DosageForm.Pill,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Tablet,
  },
  {
    id: "his-13",
    scheduleId: "sch-13",
    scheduledTime: historyOccurrence("sch-13", -6),
    intakenTime: dayjs(historyOccurrence("sch-13", -6))
      .add(22, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 4,
    medicationIdSnapshot: "med-13",
    medicationNameSnapshot: "Sleep Aid",
    medicationDosageFormSnapshot: DosageForm.Capsule,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Capsule,
  },
  {
    id: "his-14",
    scheduleId: "sch-14",
    scheduledTime: historyOccurrence("sch-14", -6),
    intakenTime: dayjs(historyOccurrence("sch-14", -6))
      .add(10, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 5,
    medicationIdSnapshot: "med-14",
    medicationNameSnapshot: "Digestive Enzyme",
    medicationDosageFormSnapshot: DosageForm.Capsule,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Capsule,
  },
  {
    id: "his-15",
    scheduleId: "sch-15",
    scheduledTime: historyOccurrence("sch-15", -7),
    intakenTime: dayjs(historyOccurrence("sch-15", -7))
      .add(28, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 3,
    medicationIdSnapshot: "med-15",
    medicationNameSnapshot: "Skin Ointment",
    medicationDosageFormSnapshot: DosageForm.Liquid,
    amountSnapshot: 5,
    doseUnitSnapshot: DoseUnit.Ml,
  },
  {
    id: "his-16",
    scheduleId: "sch-16",
    scheduledTime: historyOccurrence("sch-16", -30),
    intakenTime: dayjs(historyOccurrence("sch-16", -30))
      .add(8, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 5,
    medicationIdSnapshot: "med-16",
    medicationNameSnapshot: "B Complex",
    medicationDosageFormSnapshot: DosageForm.Tablet,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Tablet,
  },
  {
    id: "his-17",
    scheduleId: "sch-17",
    scheduledTime: historyOccurrence("sch-17", -1),
    intakenTime: dayjs(historyOccurrence("sch-17", -1))
      .add(17, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 4,
    medicationIdSnapshot: "med-17",
    medicationNameSnapshot: "Electrolyte Mix",
    medicationDosageFormSnapshot: DosageForm.Powder,
    amountSnapshot: 1,
    doseUnitSnapshot: DoseUnit.Package,
  },
  {
    id: "his-18",
    scheduleId: "sch-18",
    scheduledTime: historyOccurrence("sch-18", 0),
    intakenTime: dayjs(historyOccurrence("sch-18", 0))
      .add(9, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
    rate: 3,
    medicationIdSnapshot: "med-18",
    medicationNameSnapshot: "Cold Relief",
    medicationDosageFormSnapshot: DosageForm.Capsule,
    amountSnapshot: 2,
    doseUnitSnapshot: DoseUnit.Capsule,
  },
  {
    id: "his-19",
    scheduleId: "sch-01",
    scheduledTime: buildOccurrenceTime(
      RES_SCHEDULES[0],
      NOW,
      "21:00",
    ),
    intakenTime: dayjs(
      buildOccurrenceTime(RES_SCHEDULES[0], NOW, "21:00"),
    )
      .add(6, "minute")
      .toISOString(),
    status: HistoryStatus.taken,
...
const HISTORY_REASON_BY_ID: Partial<Record<string, string>> = {
  "his-03":
    "Headache started after a long meeting, so the dose was taken a bit later.",
  "his-13": "Bedtime shifted because of overtime.",
  "his-22":
    "Missed the late-night dose after falling asleep on the couch.",
};

const HISTORY_SOURCE_BY_ID: Partial<
  Record<string, IDB_History["source"]>
> = {
...
const DB_HISTORIES: IDB_History[] = DB_HISTORY_SEEDS.map(
  (history) => ({
    ...history,
    takenAmount:
      history.status === HistoryStatus.taken
        ? history.amountSnapshot
        : null,
    ...
    source:
      HISTORY_SOURCE_BY_ID[history.id] ??
...
const toResolvedHistory = (history: IDB_History): IRES_History => {
  const schedule = RES_SCHEDULES.find(
    (item) => item.id === history.scheduleId,
  );
  const patient = schedule
    ? DB_PATIENTS.find((item) => item.id === schedule.patientId)
    : undefined;
...
export const RES_HISTORIES: IRES_History[] = DB_HISTORIES.map(
  toResolvedHistory,
).sort((a, b) =>
  dayjs(a.scheduledTime).isBefore(dayjs(b.scheduledTime)) ? 1 : -1,
);

export const RES_CARE_PATIENTS: IRES_CarePatientSummary[] =
  DB_CARE_RELATIONSHIPS.map((relationship) => {
    if (!relationship.caregiverUserId) {
      return null;
    }

    const patient = DB_PATIENTS.find(
...
export const deriveEventsByDate = (targetDate: dayjs.Dayjs) => {
  ...
  for (const schedule of RES_SCHEDULES) {
    if (
      !occursOnDate(schedule, targetDate) ||
      !matchesCountLimit(schedule, targetDate)
    ) {
      continue;
    }

    const medication = DB_MEDICATIONS.find(
      (item) => item.id === schedule.medicationId,
    );
    const patient = DB_PATIENTS.find(
      (item) => item.id === schedule.patientId,
    );
    ...
    for (const timeSlot of schedule.timeSlots) {
      ...
      const history = DB_HISTORIES.find(
        (item) =>
...
export const deriveEventsByDateForPatient = (
...
export const deriveHistoriesByDate = (targetDate: dayjs.Dayjs) => {
  ...
  return events
    ...
    .map<IRES_History>((event) => ({
      ...
      patientId:
        RES_SCHEDULES.find((item) => item.id === event.scheduleId)
          ?.patientId ?? "",
      patientName:
        DB_PATIENTS.find(
          (item) =>
      ...
      takenAmount:
        event.takenAmount ??
        (event.status === HistoryStatus.taken ? event.amount : null),
      memo: event.memo ?? null,
      feeling: event.feeling ?? null,
      reason: event.reason ?? null,
      source:
        event.source ??
        (event.status === HistoryStatus.missed
          ? HistorySource.system
          : HistorySource.quickCheck),
    ...
    .sort((a, b) =>
      dayjs(a.scheduledTime).isBefore(dayjs(b.scheduledTime))
        ? 1
        : -1,
    );
};

export const deriveHistoriesByDateForPatient = (
  patientId: IDB_Patient["id"],
  targetDate: dayjs.Dayjs,
) =>
