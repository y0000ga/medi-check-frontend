...
import { SelectedSchedulePatient } from "@/features/schedule/createScheduleMachine";

type SelectPatientStepProps = {
  selectedPatient: SelectedSchedulePatient | null;
  onSelectPatient: (patient: SelectedSchedulePatient) => void;
};
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.description}>請先選擇要建立排程的照護對象。</Text>
      </View>
